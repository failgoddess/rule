...
import com.goddess.rule.executer.mode.formula.DataNode;
...
public class Param extends BaseDataPo {
    ...
    public static JSONObject buildParams(DecisionContext decisionContext,List<Param> params){
        return buildParams(decisionContext,params,new JSONObject());
    }
    public static JSONObject buildParams(DecisionContext decisionContext,List<Param> params, JSONObject data){
        ...
        for (Param param : params) {
            if(param.getDataFormulaNode()!=null&&DataNode.class.equals(param.getDataFormulaNode().getClass())){
                json.put(param.getCode(),param.getDataFormulaNode().apply(decisionContext));
            }else if(data.get(param.getCode())!=null){
